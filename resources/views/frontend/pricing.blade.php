<x-frontend.template>
    ...
    {{-- <section>
        <div class="container">
            ...
            <div class="row mt-7">
                <div class="col-md-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left"><a href="#"><img class="img-fluid" src="assets/frontend/img/team/1.png" alt="" /></a>
                    <h1 class="fs-3 mt-3">Michael Scott</h1>
                    <p class="fs-1">General Manager</p>
                </div>
                <div class="col-md-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left"><a href="#"><img class="img-fluid" src="assets/frontend/img/team/2.png" alt="" /></a>
                    <h1 class="fs-3 mt-3">Dwight Schrute</h1>
                    <p class="fs-1">General Manager</p>
                </div>
                <div class="col-md-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left"><a href="#"><img class="img-fluid" src="assets/frontend/img/team/3.png" alt="" /></a>
