...
<div class="block-content block-content-full">
    <div class="bg-light py-50 px-20">
        <div class="row text-left">
            ...
            <div class="col-6 mb-2">{{ $employee->gender }}</div>
            <div class="col-6 mb-2">Date Of Birth</div>
            <div class="col-6 mb-2">{{ $employee->dob }}</div>
            <div class="col-6 mb-2">Marital Status</div>
            <div class="col-6 mb-2">{{ $employee->marital_status }}</div>
            <div class="col-6 mb-2">Personal cell number</div>
            <div class="col-6 mb-2">{{ $employee->mobile_number }}</div>
            <div class="col-6 mb-2">Emergency cell number</div>
            <div class="col-6 mb-2">{{ $employee->emergency_phone_number }}</div>
            <div class="col-6 mb-2">Work phone number</div>
            <div class="col-6 mb-2">{{ $employee->office_phone_number }}</div>
            <div class="col-6 mb-2">Personal email</div>
            <div class="col-6 mb-2">{{ $employee->personal_email }}</div>
            <div class="col-6 mb-2">Work email</div>
            <div class="col-6 mb-2">{{ $employee->email }}</div>
            <div class="col-6 mb-2">Employment Start Date</div>
            <div class="col-6 mb-2">{{ $employee->professional_experience?->start_date }}</div>
            <div class="col-6 mb-2">Direct Manager/Supervisor</div>
            <div class="col-6 mb-2">{{ $employee->direct_manager }}</div>
            <div class="col-6 mb-2">Employee Tax Number</div>
            <div class="col-6 mb-2">{{ $employee->tax_number }}</div>
